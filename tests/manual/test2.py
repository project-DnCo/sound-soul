...
MY_GUILD = discord.Object(id=714450694349783062)  # replace with your guild id
...
async def report_message(interaction: discord.Interaction, message: discord.Message):
    ...
    log_channel = interaction.guild.get_channel(714450694785990713)  # replace with your channel id
    # print(message.channel.id)
    if log_channel is None or not isinstance(log_channel, discord.abc.Messageable):
        await interaction.followup.send('Log channel not found or not messageable.', ephemeral=True)
        return
